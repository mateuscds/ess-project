...
function existeTurma(codigo: string){
...
function retornaTurma(codigo: string){
...
function existeTurmaDiferente(turma_modificada: Turma, index: number){
...
function retornaAlunoConvidado(email: string){
...
function existeConvidado(list_convidados: [Usuario, string][], email: string){
...
function procuraIndexAlunoConvidado(codigo: string){
...
function atualizaListaAlunos(index_turmas: number){
