...
describe("O servidor", () => {
    ...
    it("Cadastro das informações de uma nova turma - bem sucecido", () => {
        ...
        return request.get(base_url + "minhas_turmas").then(body => {
            ...
            for (let a of body){
                ...
                let turma_auxiliar = new Turma('', '', '', new Professor('', '', '', ''));
    ...
    it("Cadastro das informações de uma nova turma - mal sucecido", () => {
        ...
        let professor_test = new Professor('222.444.555-66', 'Bianca', 'bianca@ufpe.br', '3456');
        request.post({'url': base_url + 'usuarios/cadastrar', 'form': professor_test});
    ...
    it("Cadastro das novas informações de uma turma - 3", () => {
        ...
        let professor_test = new Professor('111.444.555-66', 'Mateus', 'mateus@ufpe.br', '5555');
        request.post({'url': base_url + 'usuarios/cadastrar', 'form': professor_test});
    ...
    it("Cadastro de aluno durante a criação de uma turma - bem sucecido", () => {
        ...
        let professor_test = new Professor('999.222.555-66', 'Lucas', 'lucas@ufpe.br', '4444');
        request.post({'url': base_url + 'usuarios/cadastrar', 'form': professor_test});
    ...
    it("Cadastro de um aluno durante a criação de uma turma - mal sucessido", () => {
        ...
        let professor_test = new Professor('888.222.555-66', 'Jefersson', 'jef@ufpe.br', '4444');
        request.post({'url': base_url + 'usuarios/cadastrar', 'form': professor_test});
    ...
    it("Aceitação do convite pelo aluno", () => {
        ...
        let usuario_test = new Aluno('100.327.123-21', 'Igor', 'igor@ufpe.br', '2222');
        request.post({'url': base_url + 'usuarios/cadastrar', 'form': usuario_test});

        let professor_test = new Professor('200.222.555-66', 'Marcio', 'marcio@ufpe.br', '4444');
        request.post({'url': base_url + 'usuarios/cadastrar', 'form': professor_test});
